class Consumables():
    ...
    def UseConsumable(self, consumable_name, in_combat=False, poisoned=False, shield_active=False, active_buffs=None):
        if consumable_name not in ConsumablesData:
            print(f"{consumable_name} is not a valid consumable.")
            return
    ...
    def HealthPotion(self, consumable_name, in_combat=False):
        if "Health Potion" not in consumable_name:
            print(f"{consumable_name} is not a Health Potion.")
            return
        return self.UseConsumable(consumable_name, in_combat=in_combat)


    def ManaPotion(self, consumable_name, in_combat=False):
    ...
    def StaminaPotion(self, consumable_name, in_combat=False):
    ...
    def Antidote(self, in_combat=False, poisoned=False):
        return self.UseConsumable("Antidote", in_combat=in_combat, poisoned=poisoned)


    def StrengthPotion(self, in_combat=False, active_buffs=None):
        return self.UseConsumable("Strength Potion", in_combat=in_combat, active_buffs=active_buffs)


    def DefensePotion(self, in_combat=False, active_buffs=None):
        return self.UseConsumable("Defense Potion", in_combat=in_combat, active_buffs=active_buffs)


    def ShieldPotion(self, in_combat=False, shield_active=False):
        return self.UseConsumable("Shield Potion", in_combat=in_combat, shield_active=shield_active)


    def TryAutoRevive(self):
        ...
        return self.GetEffectData(scroll_name)
...
ConsumablesData.update({
    ...
    "Revival Scroll": [str(next_id + 4), "Scroll", "auto_revive", "hp", 0.40, "auto", 2, 0],
})
